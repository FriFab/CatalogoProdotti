...
import it.uniroma3.catalogo.interceptor.ProcessingTimeLogInterceptor;
import it.uniroma3.catalogo.interceptor.PromoCodeInterceptor;
import it.uniroma3.catalogo.validator.ProductValidator;
import it.uniroma3.catalogo.validator.UnitsInStockValidator;

@Configuration
@EnableWebMvc
@ComponentScan("it.uniroma3.catalogo")
